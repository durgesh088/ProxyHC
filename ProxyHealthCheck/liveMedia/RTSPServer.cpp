...
RTSPServer::createNew(UsageEnvironment& env, Port ourPort,
  ...
  std::cout<<">>>>> reclamationSeconds : "<<reclamationSeconds<<"\n"; 
...
void RTSPServer::RTSPClientConnection::handleRequestBytes(int newBytesRead) {
  ...
  ++fRecursionCount;
#ifdef DEBUG
  fprintf(stderr,"Received request bytes...: %s",fRequestBuffer); 
#endif
  do {
...
//#endif
      ...
      if (requestIncludedSessionId) {
        std::cout<<"Request including sessionIdStr, cmdName : "<<cmdName<<"urlPreSuffix : "<< urlPreSuffix <<"urlSuffix : "<<urlSuffix<<"\n";
	clientSession
